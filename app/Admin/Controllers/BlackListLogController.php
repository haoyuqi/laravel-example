...
class BlackListLogController extends AdminController
{
    /**
    ...
    {
        $show = new Show(BlackListLog::findOrFail($id));

        $show->field('id', __('Id'));
        $show->field('black_list_id', __('Black list id'));
